...
export class BotCommandService {
	...
	constructor(
		@InjectBotInstance() private readonly bot: DiscordInstance,
	...
	async loadCommands() {
		(await this.discover.providerMethodsWithMetaAtKey(BOT_COMMAND)).forEach((command) => {
